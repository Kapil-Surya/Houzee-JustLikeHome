  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> createPostUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final createPostUsersRecord = createPostUsersRecordList.isNotEmpty
            ? createPostUsersRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await UserPostsRecord.createDoc(
                            createPostUsersRecord!.reference)
